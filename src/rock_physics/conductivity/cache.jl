...
params_SEO3 = (S_bfe=5.06f24, H_bfe=0.357f0, S_bmg=4.58f26, H_bmg=0.752f0,
...
params_Jones2012 = (S=10.0f0^(3.05f0), r=0.86, H=0.91, a=0.09, params_SEO3 = params_SEO3)

params_Poe2010 = (S_H100=10.0f0^2.59f0, H_H100=1.26f0, a_H100=1.18f0, r_H100=1.0f0,
...
params_Yoshino2009 = (S_i=10.0f0^4.73f0, H_i=2.31f0, S_h=10.0f0^2.98f0, H_h=1.71f0,
    S_p=10.0f0^1.90f0, H_p=0.92f0, a_p=0.16f0, r_p=1.0f0)

# melts

params_Ni2011 = (T_corr=1146.8f0, D=0.006)
