...
# mutable struct construct_model_multiphase
#     model_list
#     mixing_type
#     resp_fields
#     # p_names
...
# function construct_model_multiphase(model_list, mixing_type)
...
#     return construct_model_multiphase(model_list, mixing_type, resp_fields)
# end

# model_mixed = construct_model_multiphase([SEO3, Ni2011], HS1962_plus())

# function (m::construct_model_multiphase)(; ϕ=0.0f0, params=(;), p...)
